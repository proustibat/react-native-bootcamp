...
const contents = [
  ...
  [
    "3. Privacy",
    `Your privacy is important to us. Please read the TOR Privacy Policy carefully for information relating to TOR collection and use of personal information. You may access the TOR Privacy Policy by visiting “Privacy Policy” at http://www.swtor.com/legalnotices/privacypolicy. When you connect to TOR Service, we may retrieve information from the computer used to log onto the TOR Service. The information we collect may include information about the computer's hardware system and any data related to the computer's operation of the TOR Software or use of TOR Services. We will not collect any personal information about you, however, without your knowledge and consent as stated in our Privacy Policy at http://www.swtor.com/legalnotices/privacypolicy.`,
  ],
  [
    "4. Content",
    `"Content" on TOR Services may include software, technology, text, artwork, music, sound, and other audio visual material, and the design and appearance of our websites. Content may be provided by third parties, including other users of TOR Services. BioWare and LucasArts do not pre-screen all Content and does not endorse, approve, or prescreen any Content that you and other users may contribute to TOR Services. You bear the entire risk of the completeness, accuracy or usefulness of Content found on TOR Services. BioWare and LucasArts reserves the right to remove Content that is objectionable to us for any reason. The decision to remove Content is in BioWare's and LucasArts' sole and final discretion. To the maximum extent permitted by applicable law, BioWare and LucasArts does not assume any responsibility or liability for Content that is generated by third parties or for the failure or delay in removing any such Content.`,
  ],
];
